   ...
   return (
     <div className={css.product} style={productStyles}>
       ...
       {discount ? (
         ...
         <p className={css.apology}>Sorry but discount on this type of product has expired ☹️ </p>
       )}
       <p>Price: {price}$</p>
       <button className={css.buttonAdd} type="button">Add to cart</button>
     </div>
   );
 };
